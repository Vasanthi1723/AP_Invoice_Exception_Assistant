...
<head>
  ...
  <meta name="description" content="AP Invoice Exception Assistant — AI-powered invoice validation">
      ...
      <div class="main-content" id="main-content">
        ...
        <div class="info-strip" id="demo-banner">
          ...
          <div class="info-strip__text">
            ...
            <span class="info-strip__desc">Upload an invoice and select a purchase order to automatically extract invoice data, compare line items, and identify exceptions.</span>
